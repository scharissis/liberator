...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/lib/6to5/transformation/transformers/es7-abstract-references.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/lib/6to5/transformation/transformers/es7-abstract-references.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/lib/6to5/transformation/transformers/</a> &#187; es7-abstract-references.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  if (!t.isExpressionStatement(parent)) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (temp) <span class="cstat-no" title="statement not covered" >value = temp;</span>
  }
&nbsp;
