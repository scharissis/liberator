...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/lib/6to5/transformation/transformers/es6-classes.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/lib/6to5/transformation/transformers/es6-classes.js</span></h1>
    <h2>
        
        Statements: <span class="metric">99.01% <small>(200 / 202)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">94.64% <small>(106 / 112)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(15 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">98.96% <small>(190 / 192)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/lib/6to5/transformation/transformers/</a> &#187; es6-classes.js</div>
</div>
<div class="body">
...
420
421
422</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
Class.prototype.superProperty = function (property, isStatic, isComputed, thisExpression) {
  return t.callExpression(
    ...
    [
      ...
      isComputed ? <span class="branch-0 cbranch-no" title="branch not covered" >property </span>: t.literal(property.name),
      thisExpression
    ]
  );
};
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (topLevelThisReference) {
<span class="cstat-no" title="statement not covered" >    method.body.body.unshift(t.variableDeclaration("var", [</span>
...
&nbsp;
        var getThisReference = function () {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (topLevel) {
            // top level so `this` is the instance
            return t.thisExpression();
          } else {
            // not in the top level so we need to create a reference
<span class="cstat-no" title="statement not covered" >            return topLevelThisReference = topLevelThisReference || self.file.generateUidIdentifier("this");</span>
          }
        };
&nbsp;
