...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/lib/6to5/transformation/transformers/es6-for-of.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/lib/6to5/transformation/transformers/es6-for-of.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/lib/6to5/transformation/transformers/</a> &#187; es6-for-of.js</div>
</div>
<div class="body">
...
&nbsp;
  if (t.isIdentifier(left) || t.isPattern(left)) {
    ...
    id = left;
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isVariableDeclaration(left)) {
    // for (var i of test)
...
<span class="cstat-no" title="statement not covered" >    throw file.errorWithNode(left, "Unknown node type " + left.type + " in ForOfStatement");</span>
  }
&nbsp;
