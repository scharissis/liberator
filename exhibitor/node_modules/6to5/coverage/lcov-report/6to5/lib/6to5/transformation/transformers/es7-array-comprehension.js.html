...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/lib/6to5/transformation/transformers/es7-array-comprehension.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/lib/6to5/transformation/transformers/es7-array-comprehension.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/lib/6to5/transformation/transformers/</a> &#187; es7-array-comprehension.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  var body  = block.body;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (traverse.hasType(node, "YieldExpression", t.FUNCTION_TYPES)) {
<span class="cstat-no" title="statement not covered" >    container.callee.generator = true;</span>
<span class="cstat-no" title="statement not covered" >    container = t.yieldExpression(container, true);</span>
  }
&nbsp;
