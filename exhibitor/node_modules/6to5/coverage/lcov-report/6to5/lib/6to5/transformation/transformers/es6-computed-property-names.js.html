...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/lib/6to5/transformation/transformers/es6-computed-property-names.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/lib/6to5/transformation/transformers/es6-computed-property-names.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/lib/6to5/transformation/transformers/</a> &#187; es6-computed-property-names.js</div>
</div>
<div class="body">
...
&nbsp;
  for (i in props) {
    prop = props[i];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (prop.kind !== "init") <span class="cstat-no" title="statement not covered" >continue;</span>
&nbsp;
    key = prop.key;
&nbsp;
